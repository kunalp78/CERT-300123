...
class Test_operations(unittest.TestCase):
    ...
    f1.truncate()
    f1.close()
    f2=open('units.json','r+')
    f2.seek(0)
    f2.truncate()
    f2.close()
    f3=open('managers.json','r+')
    f3.seek(0)
    f3.truncate()
